				...
				<div>
					<form className="flex flex-col">
						...
						<div className="relative w-full mb-5 rounded-lg shadow-md">
							...
							<input type="text" id="search" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm focus:ring-blue-500 block w-full pl-10 p-2.5" placeholder="Search Desctination" required="" />
						</div>
						<div className="flex">
						...
						<div className="relative w-full mb-5 rounded-lg shadow-md">
							...
							<input type="date" id="search_date" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm focus:ring-blue-500 block w-full pl-10 p-2.5" required="" />
						</div>
