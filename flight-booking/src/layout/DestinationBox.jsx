		...
		<div className="flex flex-col justify-center items-center w-full px-2 py-4">
			<div className="w-10/12 mb-10">
				<div className="flex mb-5 border-b-2">
					<svg width="30px" height="30px" viewBox="-5 -2 24 24" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin" class="jam jam-map-marker">
				...
				<div>
					<form className="flex flex-col">
						<div className="flex">
							...
							<label for="search" className="ml-1 text-sm mb-2 font-bold">To:</label>
						</div>
						<div className="relative w-full mb-5 rounded-lg shadow-md">
							...
							<input type="text" id="search" className="bg-gray-50 border-4 border-orange-300 text-gray-900 text-sm focus:border-blue-300 focus:outline-none focus:ring-blue-300 block w-full pl-10 p-2.5" placeholder="Search Desctination" required="" />
						</div>
						<div className="flex">
							...
							<label for="search_date" className="ml-1 text-sm mb-2 font-bold">Date:</label>
						</div>
						<div className="relative w-full mb-5 rounded-lg shadow-md">
							<div className="flex absolute inset-y-0 left-0 items-center pl-3 pointer-events-none">
								<svg aria-hidden="true" className="w-5 h-5 text-gray-500 dark:text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M8 4a4 4 0 100 8 4 4 0 000-8zM2 8a6 6 0 1110.89 3.476l4.817 4.817a1 1 0 01-1.414 1.414l-4.816-4.816A6 6 0 012 8z" clip-rule="evenodd"></path></svg>
							</div>
							<input type="date" id="search_date" className="bg-gray-50 border-4 border-orange-300 text-gray-900 text-sm focus:border-blue-300 focus:outline-none focus:ring-blue-300 block w-full pl-10 p-2.5" required="" />
						</div>
						<button type="submit" className="shadow-md rounded-lg inline-flex items-center py-2.5 px-3 text-sm font-medium text-white bg-blue-700 border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
							<svg aria-hidden="true" className="-ml-1 w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg><p className="items-center w-full">Search</p></button>
					</form>
				</div>
			</div>
		</div>
