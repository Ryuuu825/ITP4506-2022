				...
				<div>
					<form className="flex flex-col">
						...
						<div className="relative w-full mb-5 rounded-lg shadow-md">
							...
							<input type="text" id="search" className="bg-gray-50 border-4 border-orange-300 text-gray-900 text-sm focus:ring-4 focus:outline-none focus:ring-blue-300 block w-full pl-10 p-2.5" placeholder="Search Desctination" required="" />
						</div>
						<div className="flex">
						...
						<div className="relative w-full mb-5 rounded-lg shadow-md">
							...
							<input type="date" id="search_date" className="bg-gray-50 border-4 border-orange-300 text-gray-900 text-sm focus:ring-4 focus:outline-none focus:ring-blue-300 block w-full pl-10 p-2.5" required="" />
						</div>
