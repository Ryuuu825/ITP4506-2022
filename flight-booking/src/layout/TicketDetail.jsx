		...
		<div className="flex w-full h-full p-8 justify-center items-center z-50 overflow-auto">
			<div ref={detailBox} className="flex flex-col bg-white m-auto p-4 rounded-md">
				...
				<div className="mx-4">
					...
					<br />
					<BusinessBox selectInfo={selectInfo} />
					<br />
					<FirstSuitBox selectInfo={selectInfo} />
					<br />
				</div>
			</div>
		</div>
...
export function EconomyBox({ selectInfo }) {
	...
	return (
		<div className="flex flex-col">
			<label className="text-base font-bold p-3 text-white bg-blue-800">ECONOMY FLEXI FARE CONDITIONS</label>
		...
		H53.7V23.1h20.5V34.4z"/>
							...
							<p className="text-xs grow">Baggage</p>
							<p className="text-xs font-bold ml-4">30kg</p>
						</div>
						<div className="flex flex-row items-center">
	...
	C217.214,15.205,215.407,10.016,211.744,6.089z"/>
							...
							<p className="text-xs grow">Seat selection</p>
							<p className="text-xs ml-4 text-right text-green-700 font-bold w-48">Complimentary (Standard & Forward Zone Seats)</p>
						</div>
					</div>
					<div className="flex flex-col flex-1  pr-4 mr-4 border-r">
						<div className="flex flex-row items-center">
			...
			s135.889,60.959,135.889,135.889S330.93,444.705,256,444.705z"/>
							...
							<p className="text-xs grow">Booking cancellation fee</p>
							<p className="text-xs w-fit font-bold ml-4">HK$780</p>
						</div>
						<div className="flex flex-row items-center">
							...
							<p className="text-xs grow">Booking change fee<br />(a fare difference may apply)</p>
							<p className="text-xs ml-4 text-right text-green-700 font-bold">Complimentary</p>
						</div>
						<div className="flex flex-row items-center">
							...
							<p className="text-xs grow">Not show fee</p>
							<p className="text-xs ml-4 text-right font-bold">HK$780</p>
						</div>
					</div>
					<div className="flex flex-1 flex-col">
						<p className="text-base ">Per Adult</p>
						<p className="text-sm ">Available Seat: 100</p>
						<p className="text-2xl my-4 font-bold mx-auto">HK$ {selectInfo.ticket.price.toLocaleString()}</p>
						<button onClick={toTranscationHandler} className="w-full shadow-lg h-12 border-2 text-blue-800 border-blue-800 rounded-sm font-bold hover:text-white hover:border-blue-800 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-500">SELECT</button>
					</div>
				</div>
			</div>
		</div>
...
export function PreEconomyBox({ selectInfo }) {
	...
	return (
		...
		H53.7V23.1h20.5V34.4z"/>
							...
							<p className="text-xs grow">Baggage</p>
							<p className="text-xs font-bold ml-4">35kg</p>
						</div>
						<div className="flex flex-row items-center">
							<svg version="1.1" className="-scale-x-100 mr-4" fill="currentColor" width="30px" height="30px" id="Capa_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
								viewBox="0 0 240.235 240.235" style={{ "enableBackground": "new 0 0 240.235 240.235" }}>
	...
	C217.214,15.205,215.407,10.016,211.744,6.089z"/>
							...
							<p className="text-xs grow">Seat selection</p>
							<p className="text-xs ml-4 text-right text-green-800 font-bold w-48">Complimentary (Standard & Forward Zone Seats)</p>
						</div>
					</div>
					<div className="flex flex-col flex-1 pr-4 mr-4 border-r">
			...
			s135.889,60.959,135.889,135.889S330.93,444.705,256,444.705z"/>
							...
							<p className="text-xs grow">Booking cancellation fee</p>
							<p className="text-xs font-bold ml-4">HK$780</p>
						</div>
						<div className="flex flex-row items-center">
						...
						<div className="flex flex-row items-center">
							...
							<p className="text-xs grow">No show fee</p>
							<p className="text-xs w-fit ml-4 text-right font-bold">HK$1340</p>
						</div>
					</div>
					<div className="flex flex-1 flex-col">
						<p className="text-base ">Per Adult</p>
						<p className="text-xs">Available Seat: 18</p>
						<p className="text-2xl my-4 font-bold mx-auto">HK$ {(selectInfo.ticket.price * 1.7).toLocaleString()}</p>
						<button onClick={toTranscationHandler} className="w-full shadow-lg h-12 border-2 text-gray-800 border-gray-800 rounded-sm font-bold hover:text-white hover:border-gray-800 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-500">SELECT</button>
					</div>
				</div>
			</div>
		</div>
...
export function BusinessBox({ selectInfo }) {
	const navigate = useNavigate();
	const toTranscationHandler = () => {
		navigate('/transcation', { state: { selectInfo: selectInfo } });
	};
	...
	return (
		<div className="flex flex-col">
			<label className="text-base font-bold p-3 text-white bg-green-800">BUSINESS FLEXI FARE CONDITIONS</label>
			<div className="flex flex-col border-2 border-gray-800 p-2 justify-between">
				<div className="flex flex-row py-4">
					<div className="flex flex-col flex-1 pr-4 mr-4 border-r">
						<div className="flex flex-row items-center">
		...
		H53.7V23.1h20.5V34.4z"/>
							...
							<p className="text-xs grow">Baggage</p>
							<p className="text-xs font-bold ml-4">40kg</p>
						</div>
						<div className="flex flex-row items-center">
							<svg version="1.1" className="-scale-x-100 mr-4" fill="currentColor" width="30px" height="30px" id="Capa_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
								viewBox="0 0 240.235 240.235" style={{ "enableBackground": "new 0 0 240.235 240.235" }}>
	...
	C217.214,15.205,215.407,10.016,211.744,6.089z"/>
			...
			s135.889,60.959,135.889,135.889S330.93,444.705,256,444.705z"/>
						...
						<div className="flex flex-row items-center">
							...
							<p className="text-xs grow">No show fee</p>
							<p className="text-xs w-fit ml-4 text-right font-bold">HK$1753</p>
						</div>
					</div>
					<div className="flex flex-1 flex-col">
						<p className="text-base ">Per Adult</p>
						<p className="text-xs">Available Seat: 12</p>
						<p className="text-2xl my-4 font-bold mx-auto">HK$ {(selectInfo.ticket.price * 4.2).toLocaleString()}</p>
						<button onClick={toTranscationHandler} className="w-full shadow-lg h-12 border-2 border-green-800 rounded-sm font-bold text-green-800 hover:text-white hover:border-green-800 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-500">SELECT</button>
					</div>
				</div>
			</div>
		</div>
...
export function FirstSuitBox({ selectInfo }) {
	const navigate = useNavigate();
	const toTranscationHandler = () => {
		navigate('/transcation', { state: { selectInfo: selectInfo } });
	};
	...
	return (
		<div className="flex flex-col">
			<label className="text-base font-bold p-3 text-white bg-yellow-800">FIRST/SUITES FLEXI FARE CONDITIONS</label>
			<div className="flex flex-col border-2 border-gray-800 p-2 justify-between">
				<div className="flex flex-row py-4">
					<div className="flex flex-col flex-1 pr-4 mr-4 border-r">
						<div className="flex flex-row items-center">
		...
		H53.7V23.1h20.5V34.4z"/>
							...
							<p className="text-xs grow">Baggage</p>
							<p className="text-xs font-bold ml-4">50kg</p>
						</div>
						<div className="flex flex-row items-center">
							<svg version="1.1" className="-scale-x-100 mr-4" fill="currentColor" width="30px" height="30px" id="Capa_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
								viewBox="0 0 240.235 240.235" style={{ "enableBackground": "new 0 0 240.235 240.235" }}>
	...
	C217.214,15.205,215.407,10.016,211.744,6.089z"/>
			...
			s135.889,60.959,135.889,135.889S330.93,444.705,256,444.705z"/>
						...
						<div className="flex flex-row items-center">
							...
							<p className="text-xs grow">No show fee</p>
							<p className="text-xs w-fit ml-4 text-right font-bold">HK$2350</p>
						</div>
					</div>
					<div className="flex flex-1 flex-col">
						<p className="text-base ">Per Adult</p>
						<p className="text-xs">Available Seat: 2</p>
						<p className="text-2xl my-4 font-bold mx-auto">HK$ {(selectInfo.ticket.price * 7).toLocaleString()}</p>
						<button onClick={toTranscationHandler} className="w-full shadow-lg h-12 border-2 text-yello-800 border-yellow-800 rounded-sm font-bold text-yellow-800 hover:text-white hover:border-yellow-800 hover:bg-yellow-800 focus:ring-4 focus:outline-none focus:ring-yellow-500">SELECT</button>
					</div>
				</div>
			</div>
		</div>
