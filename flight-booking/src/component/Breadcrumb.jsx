...
export default function Breadcrumb({ page, data }) {
	const [crumb, setCrumb] = useState();
	return (
		<nav className="flex w-full px-5 py-3 text-gray-700 border border-gray-200 shadow-md rounded-lg bg-white dark:bg-gray-800 dark:border-gray-700" aria-label="Breadcrumb">
