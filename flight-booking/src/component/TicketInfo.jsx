		...
		<div className="flex flex-col justify-center items-center w-full">
			<div className="shadow-md flex flex-row w-full mb-2 border rounded-lg border-gray-200 bg-white">
				...
				<div className="flex flex-col flex-1 p-4 items-end my-2 border-l">
					...
					<button className="w-full h-10 border-4 border-amber-400 rounded-sm font-bold bg-amber-400 text-gray-700 hover:border-orange-300 hover:bg-orange-300 focus:ring-4 focus:outline-none focus:ring-orange-200">View Deal</button>
				</div>
			</div>
		</div>
	);
