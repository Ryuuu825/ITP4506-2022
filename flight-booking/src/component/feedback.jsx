...
export function Success({ message , description, dismissable }) {
  ...
  if (show) {
    return (
        <div className="rounded-lg py-3 px-6 mb-3 text-base inline-flex items-center bg-green-100" role="alert">
        ...
        { dismissable &&
          <button className="bg-transparent border-0 text-2xl leading-none font-semibold outline-none focus:outline-none ml-3" onClick={() => setShow(false)}>
...
export function Error({ message , description, dismissable }) {
  ...
  if (show) {
    return (
        <div className="rounded-lg py-3 px-6 mb-3 text-base inline-flex items-center bg-red-100" role="alert">
...
export function Warning({ message , description, dismissable }) {
  ...
  if (show) {
    return (
        <div className="rounded-lg py-3 px-6 mb-3 text-base inline-flex items-center bg-yellow-100" role="alert">
...
export function Info({ message , description, dismissable }) {
  ...
  if (show) {
    return (
        <div className="rounded-lg py-3 px-6 mb-3 text-base inline-flex items-center bg-blue-100" role="alert">
